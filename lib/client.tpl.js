	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			const SURFACE_RULES = [
				...
				// was too loud), workspace label in lavender, the preview
				// badge in lavender to match the time accents
				[
				...
				// hero workspace row mode seat ("标准模式" next to the
				// headline) reads in lavender like the timestamps
				[
					"[class$=\"cubgiG_seat\"]",
					"  color: var(--dsw-ctp-lavender);"
				],
