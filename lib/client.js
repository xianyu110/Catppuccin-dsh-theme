...
window.__ModuleLoader__.load({
		...
		const SKINS = [
  {
    ...
    "tokens": {
      ...
      "--dsw-alias-markdown-code-block": "#eff1f5",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-alias-markdown-code-block": "#303446",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-alias-markdown-code-block": "#24273a",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-alias-markdown-code-block": "#1e1e2e",
      ...
      "--shiki-token-changed": "#fab387"
		...
		function apply(ctx) {
			...
			const SURFACE_RULES = [
				...
				[
					"[class$=\"_thinkBody\"]",
					"  color: color-mix(in srgb, var(--dsw-ctp-pink) 72%, var(--dsw-alias-label-tertiary));"
				],
				// tool call rows: the Think label in pink, executor
				...
				[
					...
					"  color: color-mix(in srgb, var(--dsw-ctp-pink) 55%, var(--dsw-alias-label-tertiary));"
				],
				...
				[
					"[class~=\"UQsH_q_triggerLabel\"]",
					"  color: var(--dsw-ctp-flamingo);"
				],
				[
