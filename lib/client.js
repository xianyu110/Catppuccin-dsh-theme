...
window.__ModuleLoader__.load({
		...
		const SKINS = [
  {
    ...
    "tokens": {
      ...
      "--dsw-static-neutral-bluish-400": "#9ca0b0",
      ...
      "--dsw-specific-bubble": "#eae8f5",
      "--dsw-specific-bubble-highlight": "#e3dbf4",
      ...
      "--dsw-alias-separator-primary": "rgba(136, 57, 239, 0.45)",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-static-neutral-bluish-400": "#838ba7",
      ...
      "--dsw-specific-bubble": "#56526e",
      "--dsw-specific-bubble-highlight": "#6f698b",
      ...
      "--dsw-alias-separator-primary": "rgba(202, 158, 230, 0.5)",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-static-neutral-bluish-400": "#8087a2",
      ...
      "--dsw-specific-bubble": "#4c4968",
      "--dsw-specific-bubble-highlight": "#686289",
      ...
      "--dsw-alias-separator-primary": "rgba(198, 160, 246, 0.5)",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-static-neutral-bluish-400": "#7f849c",
      ...
      "--dsw-specific-bubble": "#48435f",
      "--dsw-specific-bubble-highlight": "#675f81",
      ...
      "--dsw-alias-separator-primary": "rgba(203, 166, 247, 0.5)",
