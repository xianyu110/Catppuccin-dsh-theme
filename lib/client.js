		...
		function apply(ctx) {
			...
			ctx.effect(() => {
				...
				style.textContent = [
					...
					"  color: var(--dsw-ctp-lavender);",
					"}",
					// sidebar: session titles go mauve on hover (the row's own
					// gray hover background stays), times turn lavender
					...
					"}",
					// composer selectors: model effort in yellow, workspace and
					// model labels warm to mauve on hover (constant color stays
					// neutral — earlier "cyan" complaints were about the trigger
					// itself, not hover)
					"[class$=\"_7KE1Ra_triggerEffort\"] {",
					"  color: var(--dsw-alias-state-warn-label);",
					"}",
					"[class$=\"Sh0Q9G_triggerLabel\"]:hover,",
					"[class$=\"_7KE1Ra_triggerLabel\"]:hover {",
					"  color: var(--dsw-alias-brand-primary);",
					"}",
			...
			}, "dsh-catppuccin: chat surface tint");
