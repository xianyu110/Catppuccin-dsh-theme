...
window.__ModuleLoader__.load({
		...
		const SKINS = [
  {
    ...
    "tokens": {
      ...
      "--dsw-specific-bubble": "#ccd0da",
      "--dsw-specific-bubble-highlight": "#bcc0cc",
      ...
      "--dsw-alias-button-info-fill": "#209fb5",
      "--dsw-alias-button-info-hover": "#9cd0db",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-specific-bubble": "#51576d",
      "--dsw-specific-bubble-highlight": "#626880",
      ...
      "--dsw-alias-button-info-fill": "#85c1dc",
      "--dsw-alias-button-info-hover": "#526c82",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-specific-bubble": "#494d64",
      "--dsw-specific-bubble-highlight": "#5b6078",
      ...
      "--dsw-alias-button-info-fill": "#7dc4e4",
      "--dsw-alias-button-info-hover": "#48667e",
  ...
  },
  {
    ...
    "tokens": {
      ...
      "--dsw-specific-bubble": "#45475a",
      "--dsw-specific-bubble-highlight": "#585b70",
      ...
      "--dsw-alias-button-info-fill": "#74c7ec",
      "--dsw-alias-button-info-hover": "#40627a",
      ...
      "--shiki-token-link": "#f5e0dc"
		...
		function apply(ctx) {
			...
			// User-message bubbles get a brand tint (assistant bubbles stay
			// neutral): the official bubble token is shared by both roles, so
			// the split is injected via CSS keyed on the stable CSS-module
			// class suffixes (_userStack / _bubble), colored from our own
			// injected theme variables so it adapts per flavor automatically.
			ctx.effect(() => {
				const style = document.createElement("style");
				style.textContent = [
					"[class$=\"_userStack\"] [class$=\"_bubble\"] {",
					"  background: color-mix(in srgb, var(--dsw-alias-brand-primary) 15%, var(--dsw-alias-bg-layer-2));",
					"}"
				].join("\n");
			...
			}, "dsh-catppuccin: user bubble tint");
