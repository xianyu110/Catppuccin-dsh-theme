...
const TOKEN_MAPS = {
  dark: {
    ...
    '--dsw-specific-bubble': { mix: ['surface0', 'mauve'], t: 0.15 },
    '--dsw-specific-bubble-highlight': { mix: ['surface1', 'mauve'], t: 0.25 },
    ...
    '--dsw-alias-separator-primary': { color: 'mauve', alpha: 0.5 },
  ...
  light: {
    ...
    '--dsw-alias-separator-primary': { color: 'mauve', alpha: 0.45 },
    '--dsw-alias-scrollbar-bg-l1': 'surface0',
    '--dsw-alias-scrollbar-bg-l2': 'surface1',
    '--dsw-alias-scrollbar-hover-l1': 'surface2',
    '--dsw-alias-scrollbar-hover-l2': 'surface2',
